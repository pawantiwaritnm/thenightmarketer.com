...
<style>
    ...
    .job-card:hover .job-icons {
        animation: iconVibrate 0.6s ease-in-out;
    }
    ...
    /* .job-card:hover .job-icons {
        animation: iconPulseScale 0.6s ease-in-out;
    } */
...
<main>
    ...
    <!-- JOBS -->
    <section class="jobs-section mt-2 mt-md-5" id="open-positions">
        <div class="container">
            <div class="d-flex flex-column mb-4">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                    ...
                    <div class="d-flex gap-2 all-dept">
            ...
            <div class="row g-3" id="job-grid">
                ...
                <div class="col-md-6 col-lg-4 job-card-wrapper" data-category="{{ $job->department->id ?? '' }}">
                    <div class="job-card" data-url="{{ route('career.details', $job->slug) }}" style="cursor:pointer;">
                        <!-- <i class="fa-solid {{ $job->icon ?? 'fa-briefcase' }} job-icon-bg" id="job-icons"></i> -->
                        <i class="job-icon-bg job-icons"></i>
...
<script>
// const jobIcons = document.querySelectorAll('.job-icons');


// console.log("{{ $job->department->name }}");

// jobIcons.forEach(icon => {
//     if  ("{{ $job->department->name }}" === 'Data Analyst') {
//         icon.classList.add('fa-solid', 'fa-database');
//     } else if ("{{ $job->department->name }}" === 'Marketing') {
//         icon.classList.add('fa-solid', 'fa-bullhorn');
//     } else if ("{{ $job->department->name }}" === 'Development') {
//         icon.classList.add('fa-solid', 'fa-code');
//     } else if ("{{ $job->department->name }}" === 'Management') {
//         icon.classList.add('fa-solid', 'fa-chart-line');
//     } else if ("{{ $job->department->name }}" === 'Designing') {        
//          icon.classList.add('fa-solid', 'fa-pen-nib');
//     } else {
...
// });
  ...
  const departmentIcons = {
        'Data Analyst': 'fa-database',
        'Marketing': 'fa-bullhorn',
        'Development': 'fa-code',
        'Management': 'fa-chart-line',
        'Designing': 'fa-pen-nib',
        'HR': 'fa-users',
        'Sales': 'fa-handshake',
        'Support': 'fa-headset'
    };
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        jobCardWrappers.forEach((wrapper) => {
            ...
            const jobTag = wrapper.querySelector('.job-tag');
            const departmentName = jobTag ? jobTag.textContent.trim() : 'General';
            const iconElement = wrapper.querySelector('.job-icons');
            
            const iconClass = departmentIcons[departmentName] || 'fa-briefcase';
