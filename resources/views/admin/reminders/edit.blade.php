...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Reminder</h5>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="datetime-local" name="reminder_date" class="form-control"
                           value="{{ \Carbon\Carbon::parse($reminder->reminder_date)->format('Y-m-d\TH:i') }}" required>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="reminder_client" class="form-control select2">
                        ...
                        @foreach($clients as $client)
                            <option value="{{ $client->id }}" {{ $reminder->reminder_client == $client->id ? 'selected' : '' }}>
                                {{ $client->client_name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="reminder_project" class="form-control select2">
                        ...
                        @foreach($projects as $project)
                            <option value="{{ $project->id }}" {{ $reminder->reminder_project == $project->id ? 'selected' : '' }}>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea name="description" class="form-control" rows="5">{{ $reminder->description }}</textarea>
                </div>
            </div>
...
$('#reminderForm').submit(function(e) {
    ...
    $.ajax({
        url: '{{ route("admin.reminders.update", $reminder->id) }}',
        type: 'PUT',
        data: $(this).serialize(),
