...
@section('page-title', 'Create New SEO Entry')

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0"><i class="fas fa-plus me-2"></i>Add New SEO</h5>
    </div>
    <div class="card-body">
        <form id="seoForm">
            @csrf
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="seo_name" class="form-control" required>
                </div>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" name="keywords" class="form-control" placeholder="Enter keywords separated by commas">
            ...
            <div class="text-end">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-2"></i>Create SEO
                </button>
            </div>
        </form>
    </div>
    ...
    $.ajax({
        ...
        error: function(xhr) {
            ...
            if(errors) {
                ...
                errorMsg = 'Failed to create SEO entry';
            }
