    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="breadcrumb-main">
                <h4 class="text-capitalize breadcrumb-title">Edit Page Meta</h4>
            </div>
        </div>
    </div>
            ...
            <div class="card card-Vertical card-default card-md">
                <div class="card-body">
                    <div class="Vertical-form">
                        ...
                        @endif
                        <form method="POST" action="{{ route('pagemeta.update', $pageMeta->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input id="meta_title" type="text" name="meta_title"
                                       value="{{ old('meta_title', $pageMeta->meta_title) }}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="meta_description" name="meta_description"
                                          class="form-control @error('meta_description') is-invalid @enderror" required>{{ old('meta_description', $pageMeta->meta_description) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input id="meta_keyword" type="text" name="meta_keyword"
                                       value="{{ old('meta_keyword', $pageMeta->meta_keyword) }}"
